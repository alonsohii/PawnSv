...
static const SingleplayerCheats[][]=
{
	...
	//"AJLOJYQY", //Fußgaenger greifen sich gegenseitig an, Golf Club verfuegbar
	//"BAGOWPG", //Kopfgeld ist auf dich ausgesetzt
	//"FOOOXFT", //Jeder ist bewaffnet
	"SZCMAWO", //Selbstmord
	//"BLUESUEDESHOES", // ueberall erscheint Elvis
	//"BGLUAWML", //Fußgaenger greifen dich an, Raketenwerfer verfuegbar
	//"CIKGCGX", //Beach Party
	...
	//"BMTPWHR", //Landwitschaftsfahrzeuge und -fußgaenger, Trucker-Outfit
